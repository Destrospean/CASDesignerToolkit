...
docker run --rm --name casdesignertoolkit-build -v "$(pwd)/..":/CASDesignerToolkit casdesignertoolkit bash -c "/CASDesignerToolkit/tools/_build.sh && cd /CASDesignerToolkit/CASDesignerToolkit/bin/Release/ && rm *.pdb && cp /CASDesignerToolkit/GameFolders.xml ."
